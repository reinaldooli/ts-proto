...
function isWithinOneOfThatShouldBeUnion(options, field) {
    return isWithinOneOf(field) && options.oneof === options_1.OneofOption.UNIONS;
}
...
function toTypeName(ctx, messageDesc, field) {
    ...
    if ((!isWithinOneOf(field) && isMessage(field) && !options.useOptionals) ||
        (isWithinOneOf(field) && options.oneof === options_1.OneofOption.PROPERTIES && !options.useOptionals)) {
