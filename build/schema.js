...
const fileDescriptorProto = ts_poet_1.imp('FileDescriptorProto@ts-proto-descriptors/google/protobuf/descriptor');
function generateSchema(ctx, fileDesc, sourceInfo) {
  ...
  `);
    ...
    function addReference(localName, symbol) {
        references.push(ts_poet_1.code `'.${fileDesc.package}.${localName.replace(/_/g, '.')}': ${symbol}`);
    }
